<template>
    <div>
      <my-header :cartItemCount="cartItemCount"></my-header> <!-- Header Component가 전달받은 cartitemCount 값을 보여준다 -->
      <div class="row">
              ...
              <div class="form-group">
                <div class="col-md-2">
                  ...
                  <select v-model="order.state" class="form-control">
                    ...
                    <option v-for="(state, key) in states" v-bind:key="state"> <!-- v-bind:value -->
                      {{key}}
                    </option>
                  </select>
                </div>
...
<script>
import MyHeader from './Header.vue'; // Header Component를 불러온다.
export default {
  name: 'Form',
  props: ['cartItemCount'],
  data() {
